...
window.AnnotationSpecData = {
  ...
  'btn-clear-customer-chat': {
    ...
    query: [],
    interaction: [
      '二次确认 → 清空消息区全部内容（欢迎区、待跟进摘要、最近访问、用户/助手气泡、系统提示）',
  ...
  'chat-messages': {
    name: '对话框 · 消息区（整体）',
    module: '2.3',
    content: ['承载智能助手气泡、用户气泡、系统提示、各类卡片'],
    query: [],
    interaction: [
      '纵向滚动；新消息滚到底部',
  ...
  'card-template-followup': {
    ...
    content: [
      '渠道标签「服务号消息」',
      '标题「今日待跟进提醒」',
      '正文「您有 N 家企业待跟进…」（N 为待跟进企业数量）',
      '主按钮「查看待跟进列表」'
    ],
    query: [
      '服务号模板消息配置（标题、正文、按钮文案）；N 与今日待跟进查询接口一致',
      '深链参数：tpl=followup（并排展示微信模板区 + H5 销售助手）'
    ],
    interaction: [
      '推送时机：每日 9:00 自动推送',
      '服务号推送：用户在微信看到模板消息（标题+摘要+按钮，样式由微信模板定义）',
      '演示页左侧为微信会话区展示本卡；右侧为 H5 对话（首屏仅欢迎、待跟进摘要、最近访问，不含本卡）',
      '用户点击卡内「查看待跟进列表」→ 进入/聚焦 H5 → 模拟发送「今日待跟进」→ 约 300ms 后回复待跟进列表卡',
      '与摘要卡点击列表、技能「待跟进」效果一致'
    ]
  },
  'chat-skill-bar': {
    name: '技能横滑条',
